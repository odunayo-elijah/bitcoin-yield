...
;; Calculates accrued yield for a user's deposit in a specific protocol
;; Uses time-based calculation based on Stacks block height
...
;; Withdraws principal and accrued yield from a protocol
;; Automatically calculates and includes earned yield
...
;; Initializes the contract with default Bitcoin Layer-2 yield protocols
...
;; Auto-initialize the contract upon deployment
